...
# Influxdb writer
###
MF_INFLUX_WRITER_LOG_LEVEL=debug MF_INFLUX_WRITER_CONFIG_PATH=../docker/addons/influxdb-writer/config.toml MF_INFLUX_WRITER_PORT=8900 MF_INFLUX_WRITER_DB_PORT=8086 MF_INFLUX_WRITER_DB_USER=mainflux MF_INFLUX_WRITER_DB_PASS=mainflux MF_INFLUX_WRITER_CONTENT_TYPE=application/senml+json $BUILD_DIR/mainflux-influxdb-writer &
